...
awk '$1=="FrameConsumerLog::RemainFrames:" {print $2}' log7.out > ~/gitUpload/assn3/q5.out
awk '$1=="FrameConsumerLog::RemainFrames:" {print $2}' log8.out > ~/gitUpload/assn3/q6.out
